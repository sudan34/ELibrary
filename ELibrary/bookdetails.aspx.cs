    ...
    public partial class bookdetails : System.Web.UI.Page
    {
        ...
        void addNewBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl(book_id,book_name,genre,auther_name,publisher_name,publisher_date,language,edition,book_cost,no_of_pages,book_description,actual_stock,current_stock,book_img_link) values(@book_id,@book_name,@genre,@auther_name,@publisher_name,@publisher_date,@language,@edition,@book_cost,@no_of_pages,@book_description,@actual_stock,@current_stock,@book_img_link)", con);

                cmd.Parameters.AddWithValue("@book_id", TextBox10.Text.Trim());
                cmd.Parameters.AddWithValue("@book_name", TextBox1.Text.Trim());
                cmd.Parameters.AddWithValue("@genre", genres);
                cmd.Parameters.AddWithValue("@auther_name", DropDownList4.SelectedItem.Value);
        ...
        bool checkIfBookExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from book_master_tbl where book_id='" + TextBox10.Text.Trim() + "' OR book_name='" + TextBox1.Text.Trim() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        void getBookByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from book_master_tbl WHERE book_id='" + TextBox10.Text.Trim() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
                {
                    ...
                    TextBox15.Text = "" + (Convert.ToInt32(dt.Rows[0]["actual_stock"].ToString()) - Convert.ToInt32(dt.Rows[0]["current_stock"].ToString()));
                    ...
                    DropDownList4.SelectedValue = dt.Rows[0]["auther_name"].ToString().Trim();
        ...
        void deleteBookByID()
        {
            if (checkIfBookExist())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE from book_master_tbl WHERE book_id='" + TextBox10.Text.Trim() + "'", con);
        ...
        void updateBookByID()
        {
            ...
            if (checkIfBookExist())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl set book_name=@book_name, genre=@genre, auther_name=@auther_name, publisher_name=@publisher_name, publisher_date=@publisher_date, language=@language, edition=@edition, book_cost=@book_cost, no_of_pages=@no_of_pages, book_description=@book_description, actual_stock=@actual_stock, current_stock=@current_stock, book_img_link=@book_img_link where book_id='" + TextBox10.Text.Trim() + "'", con);
